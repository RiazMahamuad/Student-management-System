...
public class ListOfStudent extends javax.swing.JFrame {
    ...
    public ListOfStudent() {
        ...
        try
        {
            ...
            while(rs.next())
            {
                mode.addRow(new Object[]{rs.getString(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(8),rs.getString(9),rs.getString(10),rs.getString(11)});
            }
        }
        catch(Exception e)
        {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Name", "Mobile", "Email", "Deferment", "Subject", "FatherName", "MotherName", "Shift", "Age", "Gender"
            }
        ));
